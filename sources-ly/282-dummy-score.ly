...
%	ragged-last-bottom = ##f
    ...
    \header {
      ...
      piece = \markup { \fontsize #2 \bold \column \center-align { \line { \hspace #9 "Wie nach einer Wasserquelle  (COPIE du 254)" }
...
\break
	...
	\new PianoStaff <<
	\set PianoStaff.instrumentName = \markup { \bold \huge "282." }
