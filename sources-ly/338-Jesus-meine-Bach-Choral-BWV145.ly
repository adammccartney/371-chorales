...
%	ragged-last-bottom = ##f
  ...
  upper = {
	...
	\repeat volta 2 {
        ...
        d4 d cis2\fermata |
        b8 cis d4 a8 g fis4 |
        g4 fis e d4\fermata | } %fin du repeat
        fis4 gis ais b8 cis |
        d4 cis b2\fermata |
        cis4 d e fis |
        e4 e d2\fermata |
	...
	\repeat volta 2 {
        ...
        fis8 b a gis a2 |
        b4 a a a |
        g4 a8 b! b a16 g! fis4 | } %fin du repeat
        b4 b cis b |
        b4 ais8 e' d2 |
        e4 fis e d |
        d4 cis a2 |
	...
	\repeat volta 2 {
        ...
        b4 e a,2\fermata |
        g'4 fis cis d8 c |
        b8 bes a gis a4 d4\fermata | } %fin du repeat
        dis4 e4 ~ e8 d g4 |
	...
	\new PianoStaff <<
	\set PianoStaff.instrumentName = \markup { \bold \huge "338." }
