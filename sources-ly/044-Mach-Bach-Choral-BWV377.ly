...
%	ragged-last-bottom = ##f
  ...
  upper = {
	...
	\repeat volta 2 {
        ...
        b8 cis d4 cis e |
        fis8 gis a4 b a4 ~ |
	a4 gis4 e } %fin du repeat
        e4 |
        fis4 e d8 e fis4 |
        e4 a,8 b cis4 fis8 e |
        d8 e4 d8 ~ d cis d4 |
        d4 cis a
        \bar "|."
	} % fin de relative
	...
	\repeat volta 2 {
        d4 |
        d8 cis b4 cis d |
        e4 fis8 g a4\fermata cis4 |
        b4 a gis a |
        d,4 e a,\fermata } %fin du repeat
        a'8 g |
        fis8 d e fis g fis e dis |
	...
	\new PianoStaff <<
	\set PianoStaff.instrumentName = \markup { \bold \huge "44." }
